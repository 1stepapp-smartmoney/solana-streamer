...
use crate::streaming::event_parser::protocols::photon::{discriminators, PhotonPumpFunTradeEvent, PhotonPumpSwapTradeEvent};
...
pub const CONFIGS: &[GenericEventParseConfig] = &[
    GenericEventParseConfig {
        ...
        instruction_parser: Some(parse_photon_pumpfun_buy_instruction),
    ...
    GenericEventParseConfig {
        ...
        inner_instruction_parser: None,
        instruction_parser: Some(parse_photon_pumpfun_sell_instruction),
        requires_inner_instruction: false,
    },
    GenericEventParseConfig {
        program_id: PHOTON_PROGRAM_ID,
        ...
        inner_instruction_parser: None,
        instruction_parser: Some(parse_photon_pumpswap_trade_instruction),
        requires_inner_instruction: false,
    },
];
